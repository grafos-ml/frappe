...
> USAGE $ loaddata <type> <directory>

@<type>: Is the type of file it will parse. The two kind of files there is
    are all json.
    OPTIONS: user, app
        user: The user option parse the user files. the format of this files
        are defined as:
            {
...
@<directory>: the directory to look for the files. The script will try to
search for files in all sub-directories.
