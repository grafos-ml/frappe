...
class User(models.Model):
    ...
    """
    external_id = models.CharField(_("external id"), max_length=255)
    items = models.ManyToManyField(Item, verbose_name=_("items"), blank=True, through="Owned")
...
class Owned(models.Model):
    ...
    installation_date = models.DateTimeField(_("acquisition date"))
...
admin.site.register([Item, User, Owned, TensorModel])