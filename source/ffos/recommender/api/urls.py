...
urlpatterns = patterns("",
    ...
    url(r'^item/(?P<app_external_id>[0-9]+)/(?P<data_format>\w+)/$', views.ItemAPI().as_view(), name='item_api'),
    url(r'^item/(?P<app_external_id>[0-9]+)/$', views.ItemAPI().as_view(), name='item_no_format_api'),
    url(r'^item/(?P<app_external_id>[0-9]+).(?P<data_format>\w+)$', views.ItemAPI().as_view(), name='item_file_api'),
